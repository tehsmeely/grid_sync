...
export var max_speed = Vector3(4.5, 4.5, 4.5)
export var local = true

# Input Actions
export var rotate_left_action = "camera_rot_left"
export var rotate_right_action = "camera_rot_right"
export var rotate_up_action = "camera_rot_up"
export var rotate_down_action = "camera_rot_down"
export var forward_action = "camera_fwd"
export var backward_action = "camera_back"
export var left_action = "camera_left"
export var right_action = "camera_right"
...
export (NodePath) var _ui_parent
var ui_parent
...
func _ready():
	...
	set_enabled(enabled)
	ui_parent = get_node(_ui_parent)
	print("Ui Parent: ", ui_parent)

	if use_gui:
		_gui = preload("camera_control_gui.gd")
		_gui = _gui.new(self, gui_action)
		if ui_parent != null:
			ui_parent.add_child(_gui)
		else:
			self.add_child(_gui)
